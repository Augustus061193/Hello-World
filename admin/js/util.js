...
function checkAlltrailer(obj){
		var count	=	document.getElementById('counttrailer').value;	

		if(obj.checked==false){
				for(var i=0;i<count;i++){
				
						document.getElementById('chkIdt'+i).checked=false;
				}
		}
		else if(obj.checked==true){
				for(var i=0;i<count;i++){
						document.getElementById('chkIdt'+i).checked=true;
				}
		}
}					
