    ...
    */  
    if(trim($title)==''  || trim($description)==''){
        ...
        */
        $obj    =   new News();
      $pub=1;
        $options    =   array('title'=>$title,'content'=>$description,'id'=>$id);
                
        if($obj->updatenews($options)){  //successfully updated , set messge queue]
...
<input type="hidden" name="id" value="<?php echo $id; ?>"/>
                        <div class="mod-content">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <input type="text" name="title" value="<?php echo $newsdet[0]['title']; ?>">
                                </div>
                            </div>
  ...
  <br>
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <textarea class="input-xlarge" rows="6" name="description" id="abt-desc"><?php echo $newsdet[0]['content']; ?></textarea>
